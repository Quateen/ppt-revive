...
// public class PptProcessCommand : IRequest<ResponseBase>
// {
//    public IFormFile File { get; set; } = null!;
// }

// public class PptProcessHandler : IRequestHandler<PptProcessCommand, ResponseBase>
// {
...
//    public PptProcessHandler(IUser currentUser, IHttpClientFactory httpClientFactory, IConfiguration configuration, IPubMedRepository pubMedRepo)
//    {
...
//        };
//    }
//    public async Task<ResponseBase> Handle(PptProcessCommand request, CancellationToken cancellationToken)
//    {
//        try
//        {
...
//            var fileDirectory = Path.Combine(Directory.GetCurrentDirectory(), "UploadedPPTs");
//            Directory.CreateDirectory(fileDirectory);

//            var fileName = $"{Guid.NewGuid()}_Updated_{request.File.FileName}";
...
//            Console.WriteLine($"📋 Original Text on Slide {i + 1}:\n{originalText}");
...
//            {
//                Console.WriteLine($"⚠️ Skipping Slide {i + 1} — no textual content found.");
//                continue;
//            }
...
//            Console.WriteLine($"🧠 Sending Slide {i + 1} content to OpenAI for enhancement...");
//            var analysisResult = await _pubMedRepo.AnalyzeMedicalSlideAsync(slideTextItems, articles);

//            List<SlideTextItem>? updatedItems;
//            try
//            {
//                updatedItems = JsonSerializer.Deserialize<List<SlideTextItem>>(analysisResult.SuggestedUpdate);
//                if (updatedItems == null || updatedItems.Count == 0)
//                    throw new Exception("Parsed update is null or empty.");
...
//            catch
//            {
//                Console.WriteLine($"[Slide {i + 1}] Failed to parse update JSON, skipping slide.");
//                continue;
//            }

//            var filteredItems = updatedItems.Where(item => item.SlideIndex == i).ToList();
...
//            result.Add(new SlidePagesResponse
//            {
//                SlideId = i + 1,
//                OriginalSlideContent = originalText,
//                UpdatedSlideContent = updatedContent,
//                References = new List<string> { analysisResult.Source }
//            });
//        }
